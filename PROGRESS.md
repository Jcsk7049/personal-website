...
- **🟢 09-25 經歷／學歷左右留白**：依參考圖將 Experience 容器調回與專案區相同的 `px-6 md:px-10`，兩區左右基準一致。`npm.cmd run build` 成功，commit `75634d3` 已推 main。
...
- 先將 Experience 內容容器加寬留白；依本人提供的專案區參考圖，再改為與 ProjectShowcase 相同的 `px-6 md:px-10`，確保經歷／學歷標題、內容與專案區距兩側一致。
