...
\section{專案}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{單中心試驗性研究（n=109）；設計 stay-level 5-fold 分層交叉驗證，揪出公開基準中的病人層級資料洩漏（AUROC 從虛高的 0.99 修正為真實的 0.58）。}
...
\section{技術能力}
 \begin{itemize}[leftmargin=0.0in, label={}]
    \small{\item{
     ...
     \textbf{機器學習}{: PyTorch, TensorFlow/Keras, LSTM/時間序列, SHAP/XAI, TinyML} \\
