...
\section{專案}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{單中心研究（n=107）；以 Integrated Gradients 將模型精簡至 4 個非侵入性特徵。論文獲 IEEE GCCE 2026 接受（poster）。}
            \resumeItem{接受後自行複查評估設定，發現視窗層切分使同一病人的時間窗橫跨訓練/測試集——屬過度理想化的條件；改以 stay-level 5-fold 重跑後 AUROC 0.61--0.67（原 0.98--0.99）。}
          \resumeItemListEnd
      \resumeProjectHeading
