...
\section{專案}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{ICU VAP 早期預警模型} $|$ \emph{PyTorch, LSTM, SHAP}}{2025 -- 至今}
          \resumeItemListStart
            \resumeItem{單中心試驗性研究（亞東紀念醫院 ICU，n=109）；設計 stay-level 5-fold 分層交叉驗證，揪出 PREDICT 2025 基準中的病人層級資料洩漏（AUROC 從虛高的 0.99 修正為真實的 0.58）。}
