    ...
    <div className="bg-[#F5F5F7] min-h-screen font-sans antialiased page-enter">
      ...
      <div className="pt-12">
        ...
        <main className="pt-16 pb-32 px-6 md:px-10 max-w-[980px] mx-auto">
          ...
          {/* ── Links ── */}
          <div className="pt-14 border-t border-black/[0.06] flex flex-wrap gap-3" data-reveal>
            {detail.github && (
              <a href={detail.github}
                 target="_blank" rel="noopener noreferrer"
                 className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full bg-[#1D1D1F] text-white
                            text-sm font-medium hover:bg-[#2D2D2F] transition-colors duration-[125ms]">
